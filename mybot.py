...
#     # Count existing alerts for the user
...
#     """Lists all active alerts for a user."""
#     chat_id = update.effective_chat.id
#     user_alerts = [data for alert_id, data in user_tracking.items() if data["chat_id"] == chat_id]
...
#             f"   📌 Alert ID: `{[key for key, val in user_tracking.items() if val == data][0]}`\n"
#             f"   💰 Base Price: ${data['base_price']:.4f}\n"
#             f"   🔗 Pair: {data['pair_address']}\n"
#         )
